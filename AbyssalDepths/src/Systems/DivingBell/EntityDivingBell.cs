using AbyssalDepths.src.Systems.DivingBell;
using System;
...
{
    public class ModSystemDivingBellSounds : ModSystem
    {
        ...
        private void onTick(float dt)
        {
            ...
            if (eplr.MountedOn is EntityDivingBellSeat edivingbellseat)
            {
                NowInMotion((float)edivingbellseat.Entity.Pos.Motion.Length(), dt); ;
            }
            else
            {
                NotMounted();
    ...
    public class EntityDivingBell : Entity, IRenderer, ISeatInstSupplier, IMountableListener
    {
        ...
        ModSystemDivingBellSounds modsysSounds;
        ...
        public override void Initialize(EntityProperties properties, ICoreAPI api, long InChunkIndex3d)
        {
            ...
            if (capi != null)
            {
                ...
                modsysSounds = api.ModLoader.GetModSystem<ModSystemDivingBellSounds>();
            }
        }
