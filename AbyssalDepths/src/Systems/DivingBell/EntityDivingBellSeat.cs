...
{
    public class EntityDivingBellSeat : EntityRideableSeat
    {
        public override EnumMountAngleMode AngleMode => config.AngleMode;
        Dictionary<string, string> animations => (Entity as EntityDivingBell).MountAnimations;
        ...
        public EntityDivingBellSeat(IMountable mountablesupplier, string seatId, SeatConfig config) : base(mountablesupplier, seatId, config)
        {
            RideableClassName = "divingbell";
        }
